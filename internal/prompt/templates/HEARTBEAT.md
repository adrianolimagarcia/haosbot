...
<!--
This file is checked periodically by your haosbot agent. When haosbot gateway starts with gateway.heartbeat.enabled=true, it automatically registers a protected heartbeat cron job that reads this file.
